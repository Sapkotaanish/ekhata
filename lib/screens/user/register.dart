...
class _RegisterFormState extends State<_RegisterForm> {
  ...
  void initState() {
    ...
    _firstnameController.value =
        _firstnameController.value.copyWith(text: firstname);
    _lastnameController.value =
        _lastnameController.value.copyWith(text: lastname);
    _emailController.value = _emailController.value.copyWith(text: email);
    _passwordController.value =
        _passwordController.value.copyWith(text: password);
    _password2Controller.value =
        _password2Controller.value.copyWith(text: password2);
  }
